...
if(isset($_GET['logout'])) {
  setcookie("verify", '', $timeout, '/'.$login); // clear password;
...
<body>
  ...
  <div style="width:500px; margin-left:auto; margin-right:auto; margin-top:100px; text-align:center">
  <form method="post">
    <h3>Please Login</h3>
